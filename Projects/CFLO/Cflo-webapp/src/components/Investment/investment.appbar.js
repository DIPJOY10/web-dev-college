...
// import JobList from './investment.list';
...
export default function InvestmentAppbar(props) {
    const {
        profile, name, btns,
    } = props;
    ...
    const {
        ...
        investmentPublishedIds, investmentDraftIds,
                    ...
                    <div className={classes.row}>
                        ...
                        <Menubar
                            ...
                            items={[
                                {
                                    Icon: null,
                                    text: `${Object.keys(investmentDictionary)?.length} Created`,
                                    navText: "Investments",
                                },
                                {
                                    Icon: <DoneIcon />,
