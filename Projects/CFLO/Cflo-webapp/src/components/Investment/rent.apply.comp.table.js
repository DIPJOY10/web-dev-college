...
const columns = [
    ...
    { id: 'unitRent', label: 'Unit Rent', align: 'center' },
...
export default function RentApplyCompTable(props) {
    ...
    const getData = (() => {
        ...
        for (const values of comps) {
            tempRows.push(createData(values?.name, values?.units, values?.unitRent, values?.rsf, values?.address));
