...
const ExperienceEdit = ({ open, setOpen }) => {
  ...
  const [currentExpObj, setCurrentExpObj] = useState({});
  const handleClose = () => {
    setOpen(false);
  };
                ...
                return (
                  <div className={educationCard} key={index}>
                    ...
                    <div className={educationCard__right}>
                      <IconButton
                        onClick={() => {
                          console.log(expObj._id);
                          setOpen(false);
                          setCurrentExpObj(expObj);
