...
export default function EditOrgDialog(props) {
  ...
  const updateOrgApi = async () => {
    ...
    console.log(organizationObject,' is the organization object');
    await Api.post("organization/newUpdate", organizationObject).then((res) => {
        const team = res.data
        setLoading(false);
