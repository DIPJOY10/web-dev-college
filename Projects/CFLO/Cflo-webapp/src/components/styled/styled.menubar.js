...
export default function StyledMenubar(props) {
    const {
        items,
        navState,
        setNav,
    ...
    return (
        <Paper square style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly' }}>
            <Tabs
                value={navState}
            ...
            >
                {items.map((item) => {
                    ...
                    return <Tab key={navText} icon={Icon} label={text} value={navText}
