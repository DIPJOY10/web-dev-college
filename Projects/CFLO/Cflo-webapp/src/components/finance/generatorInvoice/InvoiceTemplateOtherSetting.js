...
export default function InvoiceTemplateOtherSetting(props) {
    ...
    const {
        col, memoStyle, nextIcon, alignSwitch,
        hederText, jNameAndMemoCont, mainCont
    } = classes;
    ...
    return (
        <div className={col}>
                ...
                leftItems={[
                    (
                        <IconButton className={classes.iconButtonStyle} onClick={() => {
                            ...
                            <KeyboardBackspaceIcon className={jNameAndMemoCont} />
                        </IconButton>
                    ),
                    (
                        <div className={classes.templateHeader} >
                            <Typography className={hederText} >INVOICE GENERATOR</Typography>
                            <Typography className={hederText} style={{ marginLeft: "3px" }} >#{txTemplate?.invNo}</Typography>
                        </div>
                    ),
                    (
            ...
            <div className={mainCont} >
                ...
                <Paper className={classes.allDocsContPaper} >
                    <DocUploadComponent
