...
function RentalReport({
  ...
  const [rehabOperatingExpBreakdown, setRehabOperatingExpBreakdown] = useState(false)
  const [otherIncomeBreakdown, setOtherIncomeBreakdown] = useState(false)
  const [operatingExpBreakdown, setOperatingExpBreakdown] = useState(false)
    ...
    <div className={classes.root}>
      <div className={classes.calc_head_container}>
        <Paper elevation={2} className={classes.calculate_header}>
          <h4>Cash Needed</h4>
          <p style={projectData?.purchasePolicy?.[currentReport?.reportType]?.TotalCashNeededLimit >= parseFloat(resultData.totalCashNeeded) ? successColor : redColor}
      ...
      <Paper className={classes.financeContainer}>
        ...
        <div className={classes.financeSubCont} >
          ...
          <div className={classes.financeLabelData} >
            ...
            <p className={classes.valueSty} >{`${parseFloat(resultData.loanToValue).toFixed(2)}%`}</p>
          </div>
        </div>
        <div className={classes.financeSubCont} >
          <div className={classes.financeLabelData} >
          ...
          <div className={classes.infoData}>
                  ...
                  <div className={classes.label_text}>
                    ...
                    <h3 style={{ display: "flex", alignItems: "center" }} >
                      ...
                      {otherIncomeBreakdown ? (
                        <KeyboardArrowUpIcon
                          onClick={() => { setOtherIncomeBreakdown(false) }}
                          className={classes.DropDownIcon}
                        />
                      ) : (
                        <ExpandMoreIcon
                          onClick={() => { setOtherIncomeBreakdown(true) }}
                          className={classes.DropDownIcon}
                        />
                      )}
                    </h3>
                ...
                {!isViewOnly && (
                  <EditIcon
                    ...
                    onClick={() => {
                      ...
                      setPeriod(12 - Number(currentReport?.rehabPeriod))
                      setIsAdditionalItems(null)
            ...
            {currentReport.otherIncomeTotal ? (
              <div className={classes.p_row_Dropdown} style={{ width: "98%" }} >
                <DropDown
                  list={pieIncomeData}
                  openCloseBool={otherIncomeBreakdown}
                  isMonthly={true}
                />
              </div>
            ) : null}
                ...
                <div className={classes.label_text}>
                  ...
                  <h3 style={{ display: "flex", alignItems: "center" }} >
                    ...
                    {operatingExpBreakdown ? (
                      <KeyboardArrowUpIcon
                        onClick={() => { setOperatingExpBreakdown(false) }}
                        className={classes.DropDownIcon}
                      />
                    ) : (
                      <ExpandMoreIcon
                        onClick={() => { setOperatingExpBreakdown(true) }}
                        className={classes.DropDownIcon}
                      />
                    )}
                  </h3>
            ...
            {resultData.operatingExpenseCombined ? (
              <div className={classes.p_row_Dropdown} style={{ width: "98%" }}>
                <DropDown
                  list={pieExpenseData}
                  openCloseBool={operatingExpBreakdown}
                  isMonthly={true}
                />
              </div>
            ) : null}
                ...
                <div className={classes.dataLabelValueRow} >
                  <div className={classes.label_text}>
                    ...
                    <h3 style={{ display: "flex", alignItems: "center" }} >
                      ...
                      {rehabOperatingExpBreakdown ? (
                        <KeyboardArrowUpIcon
                          onClick={() => { setRehabOperatingExpBreakdown(false) }}
                          className={classes.DropDownIcon}
                        />
                      ) : (
                        <ExpandMoreIcon
                          onClick={() => { setRehabOperatingExpBreakdown(true) }}
                          className={classes.DropDownIcon}
                        />
                      )}
                    </h3>
              ...
              {rehabOperatingCostsItemized.length > 0 && (
                <div className={classes.p_row_Dropdown} style={{ width: "98%" }} >
                  <DropDown
                    ...
                    openCloseBool={rehabOperatingExpBreakdown}
                    isMonthly={true}
                  />
                </div>
              )}
      ...
      <Paper className={classes.financeContainer}>
        <div className={classes.financeSubCont} >
          <div className={classes.financeLabelData} >
            <div className={classes.labelText}>
              ...
              />
              <h3 style={parseFloat(resultData.capRate) > 0 ? {} : redColor} >Cap Rate {isExSmall && (<br />)} (Purchase Price)</h3>
            </div>
          ...
          <div className={classes.financeLabelData} >
            <div className={classes.labelText}>
              ...
              />
              <h3 style={parseFloat(resultData.capRateMarket) > 0 ? {} : redColor} >Cap Rate {isExSmall && (<br />)} (Market Value)</h3>
            </div>
        ...
        <div className={classes.financeSubCont} >
          ...
          {currentReport?.isFinancing && resultData.loanAmount != 0 ? (
            <div className={classes.financeLabelData} >
              <div className={classes.labelText}>
                <InfoLabel
            ...
            <div className={classes.financeLabelData} >
              <div className={classes.labelText}>
                <InfoLabel
                  obj={glossaryObjObj?.["Internal Rate of Return (Unlevered)"]}
                />
                <h3 style={parseFloat(resultData?.UnleveredIRRArray[0]) > 0 ? {} : redColor} >Internal Rate of Return (Unlevered)</h3>
              </div>
              <p className={classes.valueSty} style={parseFloat(resultData?.UnleveredIRRArray[0]) > 0 ? {} : redColor} >{`${parseFloat(resultData?.UnleveredIRRArray[0]).toFixed(2)}%`}</p>
            </div>
          )}
        </div>
      </Paper>
